...
* 设置任务的优先级：点击<img src="../images/images_ios2.6/image4206.PNG" title="优先级" width="30" />设置任务的优先级。
* 转为列表任务：点击键盘上的<img src="../images/images_ios2.6/image4207.PNG" title="列表任务" width="20" />，可以将文本任务转为列表任务。
* 快速添加标签：点击键盘上方的「#」可以快速添加标签。标签的使用请参考[使用标签](ios_app/3_manage_tasks_tags.md)。
...
<br >开启集成 Siri 之后，再用 Siri 创建的提醒事项会加入滴答清单。

...
点击左上角头像 -「设置」-「日历订阅&邮件」，使用您在滴答清单上注册的邮箱，直接将任务发送至 [todo@mail.dida365.com](todo@mail.dida365.com) ， 任务即自动生成。同时可以在邮件标题中加入时间信息，来快速设定任务时间。

您也可以查看系统自动生成的专属邮件地址，您只需要直接在邮件标题中将任务内容写入，通过任意邮箱发送到该地址，任务便会自动创建。点击重置，可以生成一个新的邮件地址。
